                                    ...
                                    <div className="Adview__main">
                                        <div className="Adview__left">
                                            <div className="Adview__box Adview__box--main">
                                                <Swiper 
                                                    ...
                                                    slidesPerView={1}
                                                    navigation={{nextEl: '.Adview__btn--right', prevEl: '.Adview__btn--left', disabledClass: 'Adview__btn--disabled'}}
                                                    ...
                                                    <div className="Adview__group Adview__group--abs">
                                                        <button className="Adview__btn DTool Adview__btn--rel Adview__btn--abs Adview__btn--corner mr-2 pos-rel" onClick={() => this.onRotate()}>
                                                            <svg className="Adview__icon" dangerouslySetInnerHTML={{__html: utils.use('rotate-cw')}} />
                                                            <Tooltip>Rotate the photo</Tooltip>
                                                        </button>
                                                        <button className="Adview__btn DTool Adview__btn--rel Adview__btn--abs Adview__btn--corner pos-rel">
                                        ...
                                        <div className="Adview__right">
                                            ...
                                            <Swiper
                                                ...
                                                scrollbar={{ el: '#scrollbar-2', draggable: true }}
                                                >
...
// ###############################################################################################################
            ...
            //                 simulateTouch={false}
            //                 keyboard={{ enabled: true, onlyInViewport: true }}> */}
            //                 <Scrollbars className="Adview__wrapper" style={{ height: '100%' }}>
            ...
            //                                         </div>
            //                                     }
            //                                     <ShadowScrollbars style={{ height: 605 }}>
            //                                         {adsFrom}
            //                                     </ShadowScrollbars>
            //                                 </div>
            //                             </div>
